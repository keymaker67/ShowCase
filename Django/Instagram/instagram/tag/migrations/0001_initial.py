    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'content': ['post', 'story']}, on_delete=django.db.models.deletion.PROTECT, related_name='tag', to='contenttypes.contenttype')),
            ],
            options={
                'verbose_name': 'Tag',
