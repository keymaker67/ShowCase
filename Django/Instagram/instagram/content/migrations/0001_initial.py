    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'content'), ('model', 'postmodel')), models.Q(('app_label', 'content'), ('model', 'storymodel')), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='mention', to='contenttypes.contenttype', verbose_name='Content type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'content'), ('model', 'postmodel')), models.Q(('app_label', 'content'), ('model', 'storymodel')), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='media', to='contenttypes.contenttype')),
            ],
            options={
                'verbose_name': 'Media',
